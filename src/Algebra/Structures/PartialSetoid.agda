...
-- The structure of this module is derived from Algebra.Structures
-- from the Agda Standard Library.
------------------------------------------------------------------------

{-# OPTIONS --without-K --safe #-}
open import Relation.Binary.PartialEquivalence using (Rel; PartialSetoid; IsPartialEquivalence; _∈_)

module Algebra.Structures.PartialSetoid {a ℓ} {A : Set a} (_≈_ : Rel A ℓ) where
...
open import Algebra.FunctionProperties.PartialSetoid _≈_
import Algebra.FunctionProperties.PartialSetoid.Consequences as Consequences
